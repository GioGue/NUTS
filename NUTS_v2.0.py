...
#indirizzo attica non funzionante: Ηρώων Πολυτεχνείου, Βρυώνη, 2nd District of Piraeus, Pireo, Municipality of Piraeus, Regional Unit of Piraeus, Attica, 185 36, Grecia
...
def address_to_coordinates_4326(address):
    """Convert an address to latitude and longitude (EPSG:4326) using Nominatim API."""
    url = "https://nominatim.openstreetmap.org/search"
    params = {'q': address, 'format': 'json', 'limit': 1}
    headers = {'User-Agent': 'NUTS/2.0 (your_email@example.com)'}  #modificare con nome plausibile se non funziona
    ...
    if response.status_code == 200 and response.json():
        ...
        raise ValueError("Address not found or failed to connect.")
